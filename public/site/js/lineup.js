(function() {
  ...
  ASSET_URL = 'img/football-players/';
  ...
  dom = {
    ...
    populateCard: function($el, data) {
      return $el.append('<h3>' + data.name + '</h3>' + '<ul class="player__card__list"><li><span>السن</span><br/>' + data.dob + '</li><li><span>الطول</span><br/>' + data.height + '</li><li><span>البلد</span><br/>' + data.origin + '</li></ul>' + '<ul class="player__card__list player__card__list--last"><li><span>الظهور</span><br/>' + data.games + '</li><li><span>الأهداف</span><br/>' + data.goals + '</li></ul>');
    },
  ...
  scenes = {
    preLoad: function() {
      ...
      return $('.team-lineup-wrapper').velocity({
        opacity: 1
      }, 0);
    },
