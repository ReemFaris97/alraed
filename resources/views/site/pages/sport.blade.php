...
@section('content')
    <div class="soical">
        ...
        <article id="images-video-slider">
            @foreach ($otherGame->images as $image)
                ...
                @else --}}
                        <a class="watch-vid-btn" data-fancybox="multimedia" data-caption=""
                            href="{{ asset($image->path) }}" data-toggle="tooltip" title="شاهد المرفق">
                            <img class="content__img" src="{{ asset($image->path) }}" alt="image">
                        </a>
                        {{-- @endif --}}
                    </div>
                </section>
        ...
        <div class="container">
            ...
            <p class="description-">{{ $otherGame->ar_name }} </p>
