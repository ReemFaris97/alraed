...
{{-- @if (hasPermission('other-games')) --}}
    <li>
        <a href="javascript:void(0);" class="menu-toggle">
            <i class="material-icons">layers</i>
            <span> الالعاب الاخري </span>
        </a>
        <ul class="ml-menu">
            <li>
                <a class="check_active" href="{{ route('admin.other-games.index') }}">

                    <span> عرض جميع الالعاب الاخري</span>
                </a>
            </li>
            <li>
                <a class="check_active" href="{{ route('admin.other-games.create') }}">
